    ...
    public function up(): void
    {
        Schema::create('arretes', function (Blueprint $table) {
            ...
            $table->foreignId('user_id')
                ...
                ->cascadeOnUpdate()
                ->nullable();
            $table->foreignId('type_arrete_id')
                ->constrained()
                ->cascadeOnDelete()
                ->cascadeOnUpdate()
                ->nullable();
            ...
            $table->enum('status', ['En Elaboration', 'Examen SGG', 'Examen Primature', 'Retour SGG', 'Retour Primature', 'En Attente Signature', 'Signé'])->default('En Elaboration');
